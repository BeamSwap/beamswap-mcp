...
Choose [hosted or local mode](access-methods.md) first. Hosted mode uses `https://api.beamswap.io/mcp` and asks for wallet approval in the browser. Local mode uses the [source build](../README.md#run-the-local-server).
